...
### KeyValues are (going to be) values that can exchange
##  array/hash -like objects with partial syncing abilities.
## 
##  This will allow complex data structures in the client with less kludging.
##
###
class KeyValue
end
