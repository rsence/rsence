...
this.type='[HTabLabel]';this._60="tabhighlight";this.tabControl=_2.tabControl;this.tabId=_2.tabId;this.setHighlight(_2.highlight);if(!this.isinherited){this.draw();}},setHighlight:function(_5){this.highlight=_5;if(_5){this.tabControl.selectTab(this.tabId);}
this.refresh();},mouseDown:function(_8,_a,_6d){if(this.tabControl&&!this.highlight){this.setHighlight(true);}},setValue:function(_4){this.base(_4);if(this.value&&this.tabControl){this.tabControl.selectTab(this.tabId);}},refresh:function(){if(this.drawn){if(this.markupElemIds['label']){var _2D=this.stringWidth(this.label,null,this.markupElemIds['label']);this.rect.setWidth(_2D+16);}
this.base();if(!this._1n){this._1n=this.bindDomElement(this._60+this.elemId);}
if(this._1n){var _3P=(prop_get(this._1n,'visibility')=='hidden');if(_3P&&this.highlight){prop_set(this._1n,'visibility','',true);}
else if(!_3P&&!this.highlight){prop_set(this._1n,'visibility','hidden',true);}}}}});HTabView=HView.extend({packageName:"tab",componentName:"tabview",constructor:function(_1,_7,_2){if(!_2){_2={};}
...
this.tabDefaults=new(Base.extend({label:'Untitled',labelHeight:21,labelWidth:192}).extend(_2));this.type='[HTabControl]';this.preserveTheme=true;this.tabs={};this._M=[];this._5t=true;if(!this.isinherited){this.draw();}},draw:function(){if(!this.drawn){var _1=this.rect;var _5k=new HRect(0,0,_1.width,this.tabDefaults.labelHeight);this.labelViews=new HTabBar(_5k,this);this.labelViews.draw();this._0c=0;var _65=0;var _68=this.tabDefaults.labelHeight;var _66=_1.width;var _67=(_1.height-this.tabDefaults.labelHeight);var _39=new HRect(_65,_68,_66,_67);this.tabDefaults.rect=new HRect(0,0,_39.width,_39.height);this.tabViews=new HView(_39,this);this.tabViews.draw();this.activeTab=-1;this.drawn=true;}
this.drawRect();},addTab:function(_0y,_2X,_u,_2D){if(this._5t){this.draw();}
if(!_0y){var _5X=this.tabDefaults.rect;_0y=new HTabView(_5X,this.tabViews);_0y.draw();}
if(!_u){var _u=this.tabDefaults.label;}
_0y.hide();if(this._M.length==0){_2X=true;}
var _0Q=_0y.viewId;this.tabs[_0Q]=_0y;this._M.push(_0Q);var _5W={label:_u,tabId:_0Q,tabControl:this,highlight:false};var _33=new HTabLabel(this._0c,this.tabDefaults.labelHeight,this.labelViews,_5W);this._0c+=(_33.rect.width-1);var _4v=_33.viewId;_33.draw();if(_4v!=_0Q){throw("HTabControlAddTabError: tabId Mismatch ("+_4v+" vs. "+
_0Q+")");}
if(_2X){this.selectTab(_0Q);}
this.refresh();return _0Q;},_5J:function(){if(this._M.length==0){this._0c=0;}
var _1p=0;for(var i=0;i<this._M.length;i++){var _u=this.labelViews.views[this._M[i]];this._0c=_1p+_u.rect.width;var _4w=new HRect(_1p,_u.rect.top,this._0c,_u.rect.bottom);this.labelViews.views[this._M[i]].setRect(_4w);this._0c--;_1p=this._0c;}},removeTab:function(_03){if(this.tabs[_03]instanceof HTabView){if(this.activeTab==_03){if(!this.selectPreviousTab()){if(!this.selectNextTab()){this.activeTab=-1;}}}
this.tabViews.destroyView(_03);this.labelViews.destroyView(_03);this.tabs[_03]=null;var _0P=this._M.indexOf(_03);this._M.splice(_0P,1);this._5J();}},removeSelectedTab:function(){this.removeTab(this.activeTab);},selectNextTab:function(){var _0P=this._M.indexOf(this.activeTab);if(_0P<this._M.length-1){return this.selectTab(this._M[_0P+1]);}
