...
ITextControl = HControl.extend({
  
  /*themePath:     IThemePath,*/
  themePath:   "components/itextcontrol/themes",
  componentName: "itextcontrol",
  constructor: function(_rect, _parentClass, _options) {
    ...
    this.type = '[ITextControl]';
    
    // To help extension:
    this._tmplLabelPrefix = "itextcontrollabel";
